...
panelContent2.innerHTML = originalContent2.repeat(10);
...
panelContent1.addEventListener('wheel', function() {
    if (panelContent1.scrollTop + panelContent1.clientHeight >= panelContent1.scrollHeight) {
        console.log("hit")
        panelContent1.innerHTML += originalContent1.repeat(5); // Append original content when reaching the bottom
    }
});
...
panelContent2.addEventListener('wheel', function() {
    if (panelContent2.scrollTop + panelContent2.clientHeight >= panelContent2.scrollHeight) {
        console.log("hit")
        panelContent2.innerHTML += originalContent2.repeat(5); // Append original content when reaching the bottom
    }
});